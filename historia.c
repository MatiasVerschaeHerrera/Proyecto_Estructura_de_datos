...
void ganado() {
    escribirLento("\nA lo lejos escuchan ruidos distantes de motores acercandose\n\nSe desplegan en camionestas blindadas, son militares del gobierno!\n\n-- Has sido rescatado!!\n\nTe comentan que la red sanctuary no resistio completa, muchos refugios han quedado atras y eres de los pocos en la region en tener aun sovrevivientes\n\nNo salvaste al mundo, es mas, queda mucho por hacer, pero conseguiste adentrar a tu equipo a pesar de todo y llegar vivos hasta el final.\n");
}

void perdido() {
    escribirLento("\nLa transmision tenia razon, el proyecto Sactuary seguia vigente y el recate llego\n\nPero este refugio ya estaba vacio, habia cadaveres por todos lados\n\nHabia señales de vida, señales de que un grupo habia resistido hasta hace poco\n\nLos militares han honrado un minuto de silecio antes de apagar las luces y continuar su viaje\n");
}